var TICKET = {
	dTid : 0,
	dTicketUrl : 'http://lpl.qq.com/web201612/data/LOLTicketInfo_#ticketid#.js',
	dTicketList : {},
	dTicketDetailList : {},
	dHasInitShare : false,
	firstFlag : true,
	...
	FillTicketInfo : function(ticket) {
		...
		$.ajax({
			...
			success : function() {
				...
				ticketObj.img = sGameInfo.GameLogo;
...
//                        </li>';
	...
	InitFaq : function() {
		...
		if (!tid) {
			tid = self.dTicketList[0]['iTicketId'];
		}
		var goUrl = self.dTicketUrl.replace('#ticketid#', tid);
		$.ajax({
			type : 'GET',
...
function isQQ() {
	...
	return chkRes;
}/*  |xGv00|a0428dd5a449b24646bde9d4b4d2a8df */